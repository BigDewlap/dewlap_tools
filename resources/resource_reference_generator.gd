...
## Called when run from the editor. Generates reference scripts for Upgrade and InventoryItem resources.
func _run():
	create_reference_script(Upgrade, "id")
	create_reference_script(InventoryItem, "id")
